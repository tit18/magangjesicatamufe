        ...
        <section className="flex items-center justify-center w-screen h-screen bg-white">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <a href="/" className="inline-flex text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-red-900 my-4">Back to Login</a>
                </div>
            </div>
        </section>
